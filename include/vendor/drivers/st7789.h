...
// Waveshare 1.69" LCD Touch ESP32-S3R8-specific configuration
...
#define ST7789_GPIO_MOSI  7
#define ST7789_GPIO_SCLK  6
#define ST7789_GPIO_CS    5
#define ST7789_GPIO_DC    4
#define ST7789_GPIO_RESET 8
#define ST7789_GPIO_BL    15
#endif
